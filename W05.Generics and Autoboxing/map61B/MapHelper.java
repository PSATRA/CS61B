...
public class MapHelper {
    /**
     * @NOTICE: Instead of making the class generic, we make methods
     * generic, just before the return type.
     */
    ...
    public static <K extends Comparable<K>, V> K maxKey(Map61B<K, V> m) {
         ...
         *
         * When used with generics (like in generic method headers), extends
         * imposes a constraint rather than grants new abilities. Extends
         * simply states a fact: You must be a subclass of whatever you're
         * extending.
         */
        List<K> keyList = m.keys(); // Doesn't need 'new', since we just want a 'representative'.
        K max = keyList.get(0);
        ...
        return max;
        /**
         * @NOTICE: We can't do k > max, so we need compareTo method, where
         * we need to extend the comparable<T>.
         */
    }
}
