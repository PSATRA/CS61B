...
public class Dog implements Comparable<Dog> {
    ...
    /** Return a negative number if this dog is less than the dog referred
     * by 'obj', and so forth. */
    public int compareTo(Dog obj) {
        return this.size - obj.size;
        // or even define the comparison as 'this.name.length - obj.name.length;'
    }
    ...
    private static class NameComparator implements Comparator<Dog> {
        public int compare(Dog a, Dog b) {
            ...
            /**
             * @NOTICE:
             * The Comparator class has a compare method that can compare
             * different types like a.name/b.name. A nested Comparator class
             * has an override compare method, which defines the compare
             * behavior.
             * This manual setting process is shown above in the override
             * compareTo(Dog obj).
